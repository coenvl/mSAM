...
options.figure.height = scale_factor * 6.5;

% Label options
options.label.font = 'times';
options.label.fontsize = scale_factor * 16;

% Legend options
options.legend.font = 'times';
options.legend.fontsize = scale_factor * 12;
options.legend.box = 'off';
options.legend.linewidth = scale_factor * .25;

% Axes options
options.axes.font = 'times';
options.axes.fontsize = scale_factor * 14;
options.axes.box = 'on';
